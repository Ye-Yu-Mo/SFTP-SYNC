---
title: "Skeleton | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/skeleton"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::skeleton::Skeleton;
```
...
```rust
rust// Use secondary color (more subtle)
