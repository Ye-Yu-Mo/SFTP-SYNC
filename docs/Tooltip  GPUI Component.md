---
title: "Tooltip | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/tooltip"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::tooltip::Tooltip;
```
...
```rust
rustactions!(my_actions, [SaveDocument]);
...
```rust
rustTooltip::new("Custom styled tooltip")
...
```rust
rust// Good: Provides helpful context
...
```rust
rust// Avoid: Redundant information
