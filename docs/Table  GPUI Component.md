---
title: "Table | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/table"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::table::{Table, TableState, TableDelegate, Column, ColumnSort, ColumnFixed, TableEvent};
```
...
```rust
rustimpl TableDelegate for MyTableDelegate {
