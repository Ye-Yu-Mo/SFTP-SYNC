---
title: "Settings | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/settings"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::setting::{Settings, SettingPage, SettingGroup, SettingItem, SettingField};
```
...
```rust
rustuse gpui_component::group_box::GroupBoxVariant;
...
```rust
rustSettingItem::new("Title", SettingField::switch(...))
...
```rust
rustSettingItem::render(|options, _, _| {
...
```rust
rustuse gpui_component::setting::NumberFieldOptions;
...
```rust
rustuse gpui_component::setting::{SettingFieldElement, RenderOptions};
