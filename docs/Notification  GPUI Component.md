---
title: "Notification | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/notification"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::notification::{Notification, NotificationType};
...
```rust
rust// Simple string notification
...
```rust
rust// Disable auto-hide (manual dismiss only)
...
```rust
rust// Using type-based ID for uniqueness
...
```rust
rust// Later, dismiss the notification
...
```rust
rust// Warning about maintenance
