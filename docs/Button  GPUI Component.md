---
title: "Button | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/button"
author:
published:
created: 2025-12-05
...
The [Button](https://docs.rs/gpui-component/latest/gpui_component/button/struct.Button.html) element with multiple variants, sizes, and states. Supports icons, loading states, and can be grouped together.

## Import

```rust
rustuse gpui_component::button::{Button, ButtonGroup};
```
...
```rust
rustButton::new("btn").primary().outline().label("Primary Outline")
...
The Button supports the [Sizable](https://docs.rs/gpui-component/latest/gpui_component/trait.Sizable.html) trait for different sizes.

```rust
rustButton::new("btn").xsmall().label("Extra Small")
...
```rust
rustButtonGroup::new("toggle-group")
...
```rust
rustuse gpui_component::button::ButtonCustomVariant;
