---
title: "VirtualList | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/virtual-list"
author:
published:
created: 2025-12-05
...
```rust
rust// The render function is only called for visible items
...
```rust
rust// Large dataset - only visible items use memory
