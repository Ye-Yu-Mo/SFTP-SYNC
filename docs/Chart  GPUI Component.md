---
title: "Chart | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/chart"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::chart::{LineChart, BarChart, AreaChart, PieChart};
```
...
```rust
rust// Basic curved line (default)
...
```rust
rustuse gpui::{linear_gradient, linear_color_stop};
...
```rust
rust// Charts automatically use theme colors
...
```rust
rust// Container with responsive sizing
...
```rust
rust// For large datasets, consider data sampling
...
```rust
rust// Use efficient data accessors
