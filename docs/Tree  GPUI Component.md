---
title: "Tree | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/tree"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::tree::{tree, TreeState, TreeItem, TreeEntry};
```
...
```rust
rustuse gpui_component::{ListItem, IconName, h_flex};
...
```rust
rustTreeItem::new("protected", "Protected Folder")
...
```rust
rustFn(usize, &TreeEntry, bool, &mut Window, &mut App) -> ListItem
```
