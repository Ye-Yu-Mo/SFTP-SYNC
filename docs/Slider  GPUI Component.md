---
title: "Slider | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/slider"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::slider::{Slider, SliderState, SliderEvent, SliderValue};
```

## Usage

```rust
rustlet slider_state = cx.new(|_| {
