---
title: "Badge | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/badge"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::badge::Badge;
```
...
```
```rust
rustuse gpui_component::avatar::Avatar;
...
```rust
rust// Badge on badge for complex status
...
```rust
rust// The badge automatically positions itself based on variant:
