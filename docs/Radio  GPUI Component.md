---
title: "Radio | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/radio"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::radio::{Radio, RadioGroup};
```
...
```rust
rustRadio::new("small").label("Small").xsmall()
...
```rust
rustRadioGroup::horizontal("horizontal-group")
...
```rust
rustRadioGroup::vertical("vertical-group")
...
```rust
rustRadioGroup::vertical("styled-group")
...
```rust
rustRadioGroup::vertical("disabled-group")
