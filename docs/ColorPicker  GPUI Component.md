---
title: "ColorPicker | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/color-picker"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::color_picker::{ColorPicker, ColorPickerState, ColorPickerEvent};
```
...
```rust
rustuse gpui::{Entity, Window, Context};
...
```rust
rustColorPicker::new(&color_picker)
...
```rust
rustuse gpui_component::{Sizable as _};
...
```rust
rustuse gpui_component::{Sizable as _, IconName);
