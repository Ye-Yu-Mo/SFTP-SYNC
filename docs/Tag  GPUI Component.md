---
title: "Tag | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/tag"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::tag::Tag;
```
...
```rust
rust// Primary tag (default filled style)
...
```rust
rustuse gpui_component::ColorName;
...
```rust
rust// Small tags with full rounding
...
```rust
rust// Note: Event handling would require additional state management
...
```rust
rust// Skill tags with pill styling
