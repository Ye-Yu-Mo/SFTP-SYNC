---
title: "Progress | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/progress"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::progress::Progress;
```
...
```rust
rust// For unknown progress duration
...
```rust
ruststruct InstallationProgress {
...
```rust
rust// The progress bar uses theme colors automatically
