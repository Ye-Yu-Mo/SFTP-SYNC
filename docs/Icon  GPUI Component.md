---
title: "Icon | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/icon"
author:
published:
created: 2025-12-05
...
Before you start, please make sure you have read: [Icons & Assets](https://longbridge.github.io/gpui-component/docs/assets) to understand how use SVG in GPUI & GPUI Component application.
...
```rust
rust// Using IconName enum directly
...
```rust
rust// Using a custom SVG file from assets
...
```rust
rustimpl RenderOnce for IconName {
...
```rust
rustuse gpui_component::button::Button;
...
```
```rust
rustIcon::new(IconName::LoaderCircle)
