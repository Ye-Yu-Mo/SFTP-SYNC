---
title: "Toggle | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/toggle"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::button::{Toggle, ToggleGroup};
```
...
```rust
rustToggleGroup::new("filter-group")
...
```rust
rust// Outline variant, small size
...
```rust
ruststruct NotificationSettings {
