---
title: "Form | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/form"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::form::{field, v_form, h_form, Form, Field};
```
