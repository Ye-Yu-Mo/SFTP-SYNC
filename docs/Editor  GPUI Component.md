---
title: "Editor | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/editor"
author:
published:
created: 2025-12-05
...
It design for high performance and can handle large files efficiently. We used [tree-sitter](https://tree-sitter.github.io/tree-sitter/) for syntax highlighting, and [ropey](https://github.com/cessen/ropey) for text storage and manipulation.
...
```rust
rustuse gpui_component::input::TabSize;
...
```rust
rust// Insert text at cursor position
...
```rust
rust// Without default appearance
