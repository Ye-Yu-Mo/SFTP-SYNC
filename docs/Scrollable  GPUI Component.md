---
title: "Scrollable | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/scrollable"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::scroll::{ScrollableElement};
...
```rust
rustuse gpui_component::{VirtualList, VirtualListScrollHandle};
...
```rust
rustuse gpui_component::scroll::ScrollbarShow;
...
```rust
rust// Automatically sync with system settings
