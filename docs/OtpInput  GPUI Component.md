---
title: "OtpInput | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/otp-input"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::input::{OtpInput, OtpState};
```
...
```rust
rustlet otp_state = cx.new(|cx| OtpState::new(6, window, cx));
...
```rust
rust// Single group (all fields together)
...
```rust
rustOtpInput::new(&otp_state).disabled(true)
```
...
```rust
rust// Set value programmatically
