---
title: "Sheet | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/sheet"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::WindowExt;
...
```rust
rustwindow.open_sheet(cx, |sheet, _, _| {
...
```rust
rustlet delegate = ListDelegate::new(items);
...
```rust
rustwindow.open_sheet(cx, |sheet, _, cx| {
...
```rust
rustwindow.open_sheet_at(Placement::Left, cx, |sheet, _, _| {
...
```rust
rustwindow.open_sheet_at(Placement::Bottom, cx, |sheet, _, _| {
