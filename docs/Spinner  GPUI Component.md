---
title: "Spinner | GPUI Component"
source: "https://longbridge.github.io/gpui-component/docs/components/spinner"
author:
published:
created: 2025-12-05
...
```rust
rustuse gpui_component::spinner::Spinner;
```
...
```rust
rustuse gpui_component::ActiveTheme;
...
```
```rust
rust// Default loader (line spinner)
...
```rust
rust// Extra small for inline text
...
```rust
rust// Show spinner only when loading
...
```
```rust
rust// Loading text with spinner
...
```
```rust
rust// Full overlay with spinner
